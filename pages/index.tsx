  ...
  return (
    <div className="min-h-screen relative text-slate-100 overflow-hidden bg-[#0b0f19]">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(11,15,25,0.66), rgba(11,15,25,0.88)), url('/assets/bg-waves.jpg')",
      ...
      <section id="faq" className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center">FAQ & DSGVO</h2>
          <div className="mt-8 space-y-4">
            {[
              {
                q: "Ist die Lösung DSGVO-konform?",
                a: "Ja. Datenschutz ist fester Bestandteil unserer Arbeit: Verschlüsselung, Datenminimierung, Zugriffskontrollen und regelmäßige Audits. Wir konzipieren Workflows so, dass sie im Einklang mit der DSGVO funktionieren – auch wenn externe Dienste integriert werden."
              },
              {
                q: "Wo werden Daten verarbeitet?",
                a: "Nach Möglichkeit in der EU. Falls Drittsysteme genutzt werden, setzen wir auf vertragliche Absicherung (AVV), Datenminimierung und technische Schutzmaßnahmen."
              },
              {
                q: "Wie sieht es mit dem EU AI Act aus?",
                a: "Wir verfolgen die Entwicklung eng, bewerten Risiken und schaffen Transparenz. Unsere Lösungen sind so ausgelegt, dass sie sich an neue regulatorische Anforderungen anpassen lassen."
              },
              {
                q: "Wie starte ich am schnellsten?",
                a: "Im Erstgespräch priorisieren wir 1–2 Use-Cases, richten Kanäle & Integrationen ein und liefern in zwei Wochen einen messbaren Go-Live."
              },
            ].map((item, i) => (
              <details
                key={i}
                className="group rounded-2xl border border-white/10 bg-white/5 px-5 py-4 open:bg-white/7"
              >
