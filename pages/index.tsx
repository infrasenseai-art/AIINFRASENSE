      ...
      <section className=\"relative overflow-hidden\">
        <div className=\"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-14 grid gap-10\">
          <div className=\"text-center\">
            ...
            <p className=\"mt-6 text-lg text-slate-300 max-w-3xl mx-auto\">Automatisierung & Dialog für moderne Unternehmen. Wir verbinden <span className=\"text-white font-semibold\">n8n-Workflows</span>, <span className=\"text-white font-semibold\">Superchat</span> und KI – für messbar schnellere, bessere Kundenprozesse.</p>
