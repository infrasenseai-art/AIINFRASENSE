...
export default function Home() {
  // einfache Icon-Zuordnung, kein spezielles TS-Typing nötig
  const featureIcons = {
    ...
    <div className="min-h-screen relative text-slate-100 overflow-hidden bg-[#0b0f19]">
      ...
      <section id="benefits" className="py-16 text-center">
        ...
        <p className="mt-3 text-slate-300 max-w-3xl mx-auto">
          Alle Bausteine, um Ihre Abläufe zu beschleunigen – mit Best Practices
          und messbaren Ergebnissen.
        </p>

        <div className="mt-12 grid md:grid-cols-4 gap-6 text-left max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {[
            {
              icon: <CheckCircle className="h-6 w-6 text-emerald-400" />,
              t: "Praxisnah",
              d: "Wir implementieren echte Workflows – vom ersten Use-Case bis zum Go-Live.",
            },
            {
              icon: <Users className="h-6 w-6 text-blue-400" />,
              t: "Enablement",
              d: "Wissenstransfer, Guidelines & Review-Zyklen für Ihr Team.",
            },
            {
              icon: <Zap className="h-6 w-6 text-pink-400" />,
              t: "Breit einsetzbar",
              d: "Templates für Service, Vertrieb und Backoffice.",
            },
            {
              icon: <BarChart4 className="h-6 w-6 text-violet-400" />,
              t: "Messbar besser",
              d: "Kürzere Antwortzeiten, weniger manuelle Arbeit.",
            },
          ].map((b, i) => (
            <div
              key={b.t}
              className="relative rounded-2xl bg-gradient-to-b from-white/5 to-white/[0.03] border border-white/10 p-6"
            >
      ...
      <section id="leistungen" className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-3 text-slate-300 max-w-3xl">
            Kommunikation, Automatisierung und KI – nahtlos kombiniert. Modular
            erweiterbar.
          </p>
            ...
            {[
              {
                ...
                title: "Omnichannel-Dialog",
                desc:
                  "WhatsApp, E-Mail & Webchat zentral steuern, Teams anbinden, Vorlagen & Routing.",
              },
              {
                icon: <Workflow className="h-7 w-7 text-blue-400" />,
                title: "Prozess-Automatisierung",
                desc:
                  "Tickets, Eskalationen, Monitoring, Reporting – zuverlässig und erweiterbar.",
              },
              {
                icon: <Brain className="h-7 w-7 text-pink-400" />,
                title: "KI-Assistenten",
                desc:
                  "Antwortvorschläge, Chatbots & Auto-Replies mit Übergabe an Agents.",
              },
            ].map((f) => (
              <div
                key={f.title}
      ...
      <section id="pakete" className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-3 text-slate-300">
            ...
            Preise besprechen wir im Erstgespräch.
          </p>
          ...
          <div className="mt-10 grid md:grid-cols-3 gap-6">
            {[
              ...
              >
                ...
                <a
                  href="#kontakt"
                  className="mt-6 inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white text-[#0b0f19]"
                >
                  {p.badge === "Enterprise"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 grid md:grid-cols-4 gap-6">
            {[
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10 rounded-xl bg-white/10 border border-white/20 grid place-items-center text-sm font-semibold">
                    {p.step}
                  </div>
      ...
      <section id="cases" className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-3 text-slate-300 max-w-3xl">
            So setzen Teams in unterschiedlichen Branchen mit uns schnell Wirkung frei.
          </p>
          <div className="mt-10 grid md:grid-cols-3 gap-6">
            {[
              {
                ...
                items: [
                  ...
                  "Antwortvorschläge für Agents",
                  "CSAT-Automatisierung",
                ],
              },
              {
              ...
              },
              {
                ...
                items: [
                  "Lead-Qualifizierung",
                  "Follow-up Auto-Mails",
                  "CRM-Sync (z. B. HubSpot)",
                ],
              },
            ].map((c) => (
              <div
      ...
      <section id="about" className="py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-3 text-slate-300">
            Wir sind Infrasenseai – ein Team mit Leidenschaft für Automatisierung, KI
            und smarte Kommunikation. Unser Ziel ist es, Unternehmen effizienter,
            kundenfreundlicher und zukunftssicher aufzustellen.
          </p>
        </div>
      </section>
      ...
      <section id="kontakt" className="py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-10 items-start">
          <div>
            ...
            <p className="mt-3 text-slate-300">
              Erzählen Sie uns kurz von Ihrem Anwendungsfall. Wir melden uns zeitnah
          ...
          <form className="p-6 rounded-2xl border border-white/10 bg-white/5 shadow-sm grid gap-4">
            <div>
              ...
              <input
                className="mt-1 w-full rounded-xl border border-white/10 bg-white/5 px-3 py-2 placeholder-slate-400"
            ...
            <div className="text-xs text-slate-400">
              Mit Absenden stimmen Sie unserer Kontaktaufnahme zu. Wir teilen keine
              Daten mit Dritten.
            </div>
          </form>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm">
              © {new Date().getFullYear()} Infrasenseai – Alle Rechte vorbehalten.
            </span>
          </div>
