...
function Header() {
  return (
    <motion.header
      ...
      className="sticky top-0 z-30 border-b border-white/10 bg-[#0b0f19]/65 backdrop-blur"
    >
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen relative text-slate-100 overflow-hidden bg-[#0b0f19]">
      {/* Hintergrund + animierte Blobs */}
      <div className="absolute inset-0 -z-10">
        <div
          className="absolute inset-0"
          style={{ backgroundImage: "url('/assets/neon-blobs.jpg')", backgroundSize:"cover", backgroundPosition:"center" }}
        />
        <div className="absolute inset-0 bg-[#0b0f19]/70" />

        <div className="pointer-events-none absolute -top-24 -left-24 w-[38rem] h-[38rem] rounded-full blur-3xl opacity-60 mix-blend-screen blobA" style={{ background:'radial-gradient(circle, rgba(236,72,153,0.55), transparent 60%)' }} />
        <div className="pointer-events-none absolute top-1/3 -right-24 w-[36rem] h-[36rem] rounded-full blur-3xl opacity-50 mix-blend-screen blobB" style={{ background:'radial-gradient(circle, rgba(59,130,246,0.5), transparent 60%)' }} />
        <div className="pointer-events-none absolute bottom-[-8rem] left-1/4 w-[42rem] h-[42rem] rounded-full blur-3xl opacity-50 mix-blend-screen blobC" style={{ background:'radial-gradient(circle, rgba(16,185,129,0.5), transparent 60%)' }} />
      </div>
      ...
      <section className="relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-14">
          <motion.div variants={stagger} initial="hidden" animate="show" className="text-center">
            ...
            <motion.p variants={fadeUp} className="mt-6 text-lg text-slate-300 max-w-3xl mx-auto">
            ...
            <motion.div variants={fadeUp} className="mt-8 flex items-center justify-center gap-3">
              <a href="#kontakt" className="px-5 py-3 rounded-xl bg-white text-[#0b0f19] font-medium transition hover:-translate-y-0.5 hover:shadow-xl active:scale-[0.98]">
            ...
            {/* Hero-Stats */}
            <motion.div variants={stagger} initial="hidden" whileInView="show" viewport={{ once:true, amount:0.2 }} className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                <motion.div key={s.k} variants={fadeUp} whileHover={{ y:-4, scale:1.01 }} transition={{ type:"spring", stiffness:300, damping:20 }} className="rounded-2xl bg-white/5 border border-white/10 px-5 py-4">
      ...
      {/* Vorteile */}
      <motion.section id="benefits" initial="hidden" whileInView="show" viewport={{ once:true, amount:0.2 }} className="py-16 text-center">
        <motion.p variants={fadeUp} className="text-slate-400 text-sm">Warum wir?</motion.p>
        <motion.h2 variants={fadeUp} className="mt-2 text-3xl sm:text-4xl font-bold">Ihre Vorteile</motion.h2>
        <motion.p variants={fadeUp} className="mt-3 text-slate-300 max-w-3xl mx-auto">Alle Bausteine, um Ihre Abläufe zu beschleunigen – mit Best Practices und messbaren Ergebnissen.</motion.p>

        <motion.div variants={stagger} className="mt-12 grid md:grid-cols-4 gap-6 text-left max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {[
            ...
            <motion.div key={b.t} variants={fadeUp} whileHover={{ y:-4, scale:1.01 }} transition={{ type:"spring", stiffness:300, damping:20 }} className="relative rounded-2xl bg-gradient-to-b from-white/5 to-white/[0.03] border border-white/10 p-6">
              ...
              <div className="flex items-center gap-3 mt-6">
                {b.icon}<span className="font-semibold">{b.t}</span>
              </div>
      ...
      {/* Leistungen */}
      <motion.section id="leistungen" variants={stagger} initial="hidden" whileInView="show" viewport={{ once:true, amount:0.2 }} className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.h2 variants={fadeUp} className="text-3xl font-bold">Leistungen</motion.h2>
          <motion.p variants={fadeUp} className="mt-3 text-slate-300 max-w-3xl">Kommunikation, Automatisierung und KI – nahtlos kombiniert. Modular erweiterbar.</motion.p>
          <div className="mt-10 grid md:grid-cols-3 gap-6">
            {[
              ...
              <motion.div key={f.title} variants={fadeUp} whileHover={{ y:-4, scale:1.01 }} transition={{ type:"spring", stiffness:300, damping:20 }} className="p-6 rounded-2xl bg-white/5 border border-white/10">
                <div className="flex items-center gap-3">{f.icon}<span className="text-lg font-semibold">{f.title}</span></div>
      ...
      {/* Pakete */}
      <motion.section id="pakete" variants={stagger} initial="hidden" whileInView="show" viewport={{ once:true, amount:0.2 }} className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.h2 variants={fadeUp} className="text-3xl font-bold">Pakete</motion.h2>
          <motion.p variants={fadeUp} className="mt-3 text-slate-300">Klar strukturierte Leistungspakete – transparent & erweiterbar. Preise besprechen wir im Erstgespräch.</motion.p>
          ...
          <div className="mt-10 grid md:grid-cols-3 gap-6">
            {[
              ...
              <motion.div key={p.badge} variants={fadeUp} whileHover={{ y:-4, scale:1.01 }} transition={{ type:"spring", stiffness:300, damping:20 }} className={`p-6 rounded-2xl border ${p.badge==='Growth' ? 'border-white/40 bg-white/10 shadow-[0_0_40px_rgba(255,255,255,0.06)]' : 'border-white/10 bg-white/5'}`}>
      ...
      {/* Ablauf */}
      <motion.section id="prozess" variants={stagger} initial="hidden" whileInView="show" viewport={{ once:true, amount:0.2 }} className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.h2 variants={fadeUp} className="text-3xl font-bold">In 2 Wochen startklar</motion.h2>
          <div className="mt-8 grid md:grid-cols-4 gap-6">
            {[
              ...
              <motion.div key={p.step} variants={fadeUp} whileHover={{ y:-4, scale:1.01 }} transition={{ type:"spring", stiffness:300, damping:20 }} className="p-6 rounded-2xl bg-white/5 border border-white/10">
      ...
      {/* Use Cases */}
      <motion.section id="cases" variants={stagger} initial="hidden" whileInView="show" viewport={{ once:true, amount:0.2 }} className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.h2 variants={fadeUp} className="text-3xl font-bold">Typische Use-Cases</motion.h2>
          <motion.p variants={fadeUp} className="mt-3 text-slate-300 max-w-3xl">So setzen Teams in unterschiedlichen Branchen mit uns schnell Wirkung frei.</motion.p>
          <div className="mt-10 grid md:grid-cols-3 gap-6">
            {[
              ...
              <motion.div key={c.title} variants={fadeUp} whileHover={{ y:-4, scale:1.01 }} transition={{ type:"spring", stiffness:300, damping:20 }} className="p-6 rounded-2xl bg-white/5 border border-white/10">
      ...
      {/* Über uns */}
      <motion.section id="about" variants={stagger} initial="hidden" whileInView="show" viewport={{ once:true, amount:0.2 }} className="py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.h2 variants={fadeUp} className="text-3xl font-bold">Über uns</motion.h2>
      ...
      {/* Kontakt */}
      <motion.section id="kontakt" variants={stagger} initial="hidden" whileInView="show" viewport={{ once:true, amount:0.2 }} className="py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-10 items-start">
          <div>
            <motion.h2 variants={fadeUp} className="text-3xl font-bold">Kostenloses Erstgespräch</motion.h2>
            <motion.p variants={fadeUp} className="mt-3 text-slate-300">
              Erzählen Sie uns kurz von Ihrem Anwendungsfall. Wir melden uns zeitnah mit einem konkreten Vorschlag.
            </motion.p>
            <motion.div variants={fadeUp} className="mt-6 p-5 rounded-2xl border border-white/10 bg-white/5">
              <div className="text-sm text-slate-300">Kontakt</div>
              <div className="mt-2 text-xs text-slate-400">infrasenseai@gmail.com</div>
            </motion.div>
          </div>
          <motion.form variants={fadeUp} className="p-6 rounded-2xl border border-white/10 bg-white/5 shadow-sm grid gap-4">
            <div>
      ...
      {/* Footer */}
      <motion.footer initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once:true }} className="py-10 border-t border-white/10">
