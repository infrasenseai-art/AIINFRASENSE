...
export default function Home() {
  ...
  return (
    <div className="min-h-screen relative text-slate-100 overflow-hidden">
      {/* Hintergrund mit Bild + animierten Blobs & Fallback-Gradient */}
      <div className="absolute inset-0 -z-10">
        ...
        {/* sichtbare, animierte Farb-Blobs */}
        <div
          className="pointer-events-none absolute -top-24 -left-24 w-[38rem] h-[38rem] rounded-full blur-3xl opacity-60 mix-blend-screen"
          style={{ background: "radial-gradient(circle, rgba(236,72,153,0.55), transparent 60%)", animation: "blobA 26s ease-in-out infinite" }}
        />
        <div
          className="pointer-events-none absolute top-1/3 -right-24 w-[36rem] h-[36rem] rounded-full blur-3xl opacity-50 mix-blend-screen"
          style={{ background: "radial-gradient(circle, rgba(59,130,246,0.5), transparent 60%)", animation: "blobB 30s ease-in-out infinite" }}
        />
        <div
          className="pointer-events-none absolute bottom-[-8rem] left-1/4 w-[42rem] h-[42rem] rounded-full blur-3xl opacity-50 mix-blend-screen"
          style={{ background: "radial-gradient(circle, rgba(16,185,129,0.5), transparent 60%)", animation: "blobC 34s ease-in-out infinite" }}
        />
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-14 grid gap-10">
          <div className="text-center">
            ...
            <p className="mt-6 text-lg text-slate-300 max-w-3xl mx-auto">
              Automatisierung & Dialog für moderne Unternehmen. Wir verbinden <span className="text-white font-semibold">n8n-Workflows</span>,
              <span className="text-white font-semibold"> superchat</span> und KI – für messbar schnellere, bessere Kundenprozesse.
            </p>
