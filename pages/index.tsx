...
export default function Home() {
  ...
  return (
    // ⚠️ KEINE Hintergrundfarbe hier – damit das Bild sichtbar ist
    <div className="min-h-screen relative text-slate-100 overflow-hidden">
      {/* HINTERGRUND: Milchstraße als vollflächiges Image + dezentes Overlay */}
      <div className="absolute inset-0 z-0">
        <Image
          src="/assets/milkyway-bg.jpg"   // ← Datei MUSS exakt so heißen
          alt=""
          fill
          priority
          className="object-cover"
        />
        {/* sehr dezentes Overlay (unauffällig, nicht geblurrt) */}
        <div className="absolute inset-0 bg-[#0b0f19]/45" />
      </div>

      {/* Ab hier liegt ALLES über dem Hintergrund */}
